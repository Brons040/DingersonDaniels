...
namespace Interplay.UI
{
    ...
    class MaterialRippleEditor : MaterialBaseEditor
    {
        ...
        private readonly GUIContent m_MaskModeContent = new GUIContent
        {
            text = "Mask Mode",
            tooltip = "The different types of mask handling modes a MaterialRipple can use.\n\n" +
                      "None: No mask is created/destroyed when creating/destroying ripples. Best option if you don't want to clip the ripples, or there is already a mask on the graphic.\n\n" +
                      "Mask: Uses a Mask component to clip the ripples to the graphic. Best option for non-rectangular graphics, but more expensive than RectMask2D.\n\n" +
                      "RectMask2D: Uses a RectMask2D component to clip the ripples to the graphic. Cheaper than the Mask component, but will only work for rectangular graphics (most cases)."
        };
        ...
        void OnEnable()
        {
            ...
            m_MaskMode = serializedObject.FindProperty("m_MaskMode");
