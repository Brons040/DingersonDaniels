...
//    [ExecuteInEditMode]
    ...
    [AddComponentMenu("InterplayUI/Material Input Field", 100)]
...
//        }
        ...
        private float GetTextHeight()
        {
			...
			return textGenerator.GetPreferredHeight(layoutText, textGenerationSettings) / scaler.scaleFactor;
        }
        ...
        private float GetSmallHintTextHeight()
        {
			...
			return textGenerator.GetPreferredHeight(hintTextObject.text, textGenerationSettings) / scaler.scaleFactor;
        }
