...
//    [AddComponentMenu("InterplayUI/MaterialUI Scaler", 50)]
...
//            }
//
//            float oldScaleFactor = m_ScaleFactor;
//
//            m_ScaleFactor = targetCanvas.renderMode == RenderMode.ScreenSpaceOverlay ? targetCanvas.scaleFactor : targetCanvas.transform.localScale.x;
//
//            if (m_ScaleFactor != oldScaleFactor)
//            {
//                if (OnScaleFactorChange != null)
//                {
//                    OnScaleFactorChange(m_ScaleFactor);
//                }
//            }
//
//            m_LastResolution = new Vector2(Screen.width, Screen.height);
