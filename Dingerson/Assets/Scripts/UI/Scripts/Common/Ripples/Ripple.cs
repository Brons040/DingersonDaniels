...
//            if (scaler != null)
//            {
//                if (scaler.targetCanvas.renderMode == RenderMode.WorldSpace)
//                {
//                    size /= scaler.targetCanvas.transform.localScale.x;
//                    size *= scaler.scaler.dynamicPixelsPerUnit;
//                }
//                else
//                {
//                    size *= scaler.targetCanvas.scaleFactor;
//                }
//            }
